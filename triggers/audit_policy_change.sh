...
-d '{
  ...
  "method": "item.create",
  "params": {
    "name": "Windows Audit Policy Change (EventID 4719)",
    "key_": "windows.audit.policychange",
    "hostid": "'$TEMPLATE_ID'",
    "type": 0,
    "value_type": 4,
    "interfaceid": "0",
...
-d '{
  ...
  "params": {
    "description": "Audit policy changed on {HOST.NAME}",
    "expression": "{'$TEMPLATE_HOST':windows.audit.policychange.last()} <> \"1\"",
    "priority": 3
  },
  "auth": "'$AUTH_TOKEN'",
  "id": 4
